...
function Button({ children, type = "", className = "" }) {
  switch (type) {
    ...
    default:
      <button className='bg-gradient-to-b from-stone-500 to-stone-800 rounded-2xl py-4 md:py-4 mt-4 font-bold hover:from-violet-400 hover:to-violet-700 w-full'>
        {children}
      </button>;
  }
}
